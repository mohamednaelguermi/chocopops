function init()
{
    ...
    player2 = new Player("player2", 0xffff12, new THREE.Vector2(-250, 0), 0);

    ground = new Ground(0xffffff, WIDTH, HEIGHT, 10,player1);
...
function Ground(color, size_x, size_y, nb_tile,player)
{
...
{
    pointLight = new THREE.PointLight(color, 50, 100000);
